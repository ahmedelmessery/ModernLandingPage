      ...
      <motion.div
        ...
        <div className="flex flex-col  items-start gap-6 mb-12">
          <h1 className="font-bold text-3xl">
            Futures of support with new shape
          </h1>
          <p className="text-sm text-gray-600">
            Siscuss your goals, determine success metrics, identify problems
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white max-w-72  rounded-2xl p-6 hover:shadow-xl transition-shadow duration-300">
